...
sessionsRouter.get("/api/sessions/githubcallback", passport.authenticate("github", {successRedirect: "/products", failureRedirect: "/login" }), sessionsController.registerGithub);;
